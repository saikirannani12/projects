...
-->
            ...
            <div class="row">
                <marquee bgcolor=yellow> <p class="h4" style="color: blue;">Board Admins are advised to upload the details of students correctly</p> </marquee>
            </div>
        </div>
        <footer style="bottom: 0; position: absolute;"><img src="footer.jpg" width="120%"></footer>
