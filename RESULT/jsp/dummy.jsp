...
-->
        ...
        <p class="h1">&nbsp;&nbsp;&nbsp;<b>TSBIE Results</b></p>
        <hr><br>
        <ul>
            <li><a href="studentres.html"><text class="h2">Click Here for &#8544; Year Results (All branches)</text></a></li>
            <br>
            <li><a href="studentres.html"><text class="h2">Click Here for &#8545; Year Results (All branches)</text></a></li>
        </ul>
