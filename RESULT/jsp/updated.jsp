...
<%
	...
	try{
		...
		rs = st.executeQuery("Select sname,sno,major,col from student where year="+year+" and  status=1 order by col");
	}
	catch(Exception e)
	{
...
<ul class="nav navbar-nav navbar-right"> 
		...
		<div class="container">
			<h2 align=center> Updated Student Results</h2>
...
out.print("<td><a href='updateRes1.jsp?num="+rs.getString(2)+"'>"+rs.getString(2)+"</a></td>");
				...
				if(flag==0)
				{
					out.print("<h1>No Results Updated Yet</h1>");
				}
			%>
			</table>
		</div>
